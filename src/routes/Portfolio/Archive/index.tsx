...
import { PortfolioStats } from './Components/Intro';
import { Empty } from './Components/Loader';
import { portfolioQuery } from './loader';

import './../../../static/styles/routes/portfolio.css';
			...
			<div id="content" className="content content--projects content--archive">
				...
				<div className="container">
					<Main className="grid grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8 py-10 lg:py-14" {
						...{ posts, options, loader: Empty, isSingle: false }
					} />
				</div>
			</div>
		</>
